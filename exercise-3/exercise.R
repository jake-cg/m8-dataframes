...
salaries.2014 <- runif(100, 10000, 100000)
...
salary57 <- salaries[57, 'salaries.2015']

# How many employees got a raise?
num.got.raise <- nrow(salaries[salaries$got.raise == TRUE,])

# What was the value of the highest raise?
highst.raise <- max(salaries$raise)
